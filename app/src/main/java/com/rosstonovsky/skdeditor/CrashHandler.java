...
import static com.rosstonovsky.skdeditor.ui.activities.MainActivity.mainContext;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
	...
	public void writeToFile(String currentStacktrace) {
		try {
			...
			fileWriter2.flush();
			fileWriter2.close();
			SharedPreferences.Editor editor = mainContext.getSharedPreferences("com.rosstonovsky.skdeditor", Context.MODE_PRIVATE).edit();
